...
const ExoticOptionsCourse = () => {
  ...
  const lessons = [
    { 
      title: "Introduction to Exotic Options",
      duration: "30 min", 
      type: "lecture"
    },
    { 
      title: t('coursesPage.complex.exotic.topics.knockInOut'),
      duration: "40 min", 
      type: "lecture"
    },
    { 
      title: t('coursesPage.complex.exotic.topics.touch'),
      duration: "35 min", 
      type: "lecture"
    },
    { 
      title: t('coursesPage.complex.exotic.topics.digitals'),
      duration: "25 min", 
      type: "lecture"
    },
    { 
      title: t('coursesPage.complex.exotic.topics.corridors'),
      duration: "30 min", 
      type: "lecture"
    },
    { 
      title: "Hedging Exotic Options",
      duration: "45 min", 
      type: "lecture"
    },
    { 
      title: "Exercise: Barrier Option Pricing",
      duration: "60 min", 
      type: "exercise"
    },
    { 
      title: "Notebook: Digital Option Strategies",
      duration: "70 min", 
      type: "notebook"
    },
    { 
      title: "Quiz: Exotic Options",
      duration: "20 min", 
      type: "quiz"
    }
  ];
      ...
      <main className="flex-1 py-8 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center text-sm text-finance-lightgray mb-8">
            ...
            <ChevronRight className="h-4 w-4 mx-2" />
            <span className="text-finance-offwhite">{t('coursesPage.complex.exotic.title')}</span>
          </div>
            ...
            <div className="lg:col-span-1">
              <div className="finance-card p-6 mb-6">
                <div className="flex items-center justify-between mb-4">
                  <h2 className="text-xl font-medium">{t('coursesPage.complex.exotic.title')}</h2>
                  <Badge variant="premium">Advanced</Badge>
                </div>
                <p className="text-finance-lightgray text-sm mb-6">
                  {t('coursesPage.complex.exotic.description')}
                </p>
                ...
                <div className="mt-8 pt-6 border-t border-finance-steel/10">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-finance-lightgray">{t('coursesPage.complex.exotic.duration')}</span>
                  </div>
                </div>
              </div>
            ...
            <div className="lg:col-span-2">
              <div className="finance-card overflow-hidden">
                <div className="aspect-video bg-finance-charcoal relative">
                  <div className="bg-[url('https://images.unsplash.com/photo-1605792657660-596af9009e82')] bg-cover bg-center w-full h-full opacity-30"></div>
                  <div className="absolute inset-0 flex items-center justify-center bg-finance-dark/50">
                    <div className="text-center">
                      ...
                      <h2 className="terminal-text text-2xl mb-4">{t('coursesPage.complex.exotic.title')}</h2>
                ...
                <div className="p-6">
                  ...
                  <div className="bg-finance-charcoal/30 rounded-md p-8 mb-6 text-center">
                    ...
                    <p className="text-finance-lightgray mb-6 max-w-md mx-auto">
                      Ce cours avancé sur les options exotiques n'est accessible qu'aux membres premium. Améliorez votre abonnement pour accéder à ce contenu.
                    </p>
                    <div className="space-y-3">
                  ...
                  <div className="finance-card p-4 mb-6 bg-finance-steel/10">
                    <h4 className="flex items-center text-finance-offwhite font-medium mb-2">
                      <Zap className="h-4 w-4 mr-2 text-finance-accent" />
                      Ce que vous découvrirez
                    </h4>
                    <p className="text-sm text-finance-lightgray">
                      Les options exotiques offrent des profils de paiement et des caractéristiques plus complexes que les options vanilla. Ce cours vous enseigne comment valoriser et gérer ces produits sophistiqués, très prisés dans le trading structuré et le marché OTC.
                    </p>
                  </div>
                  
                  <div className="mt-6 pt-6 border-t border-finance-steel/10">
                    <h3 className="text-lg font-medium mb-4">Types d'options couvertes</h3>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div className="bg-finance-steel/10 p-4 rounded-md">
                        <h4 className="text-finance-accent font-medium mb-2">Options barrières</h4>
                        <p className="text-sm text-finance-lightgray">
                          Knock-in, Knock-out, Up-and-In, Down-and-In, Up-and-Out, Down-and-Out
                        </p>
                      </div>
                      <div className="bg-finance-steel/10 p-4 rounded-md">
                        <h4 className="text-finance-accent font-medium mb-2">Options digitales</h4>
                        <p className="text-sm text-finance-lightgray">
                          Cash-or-Nothing, Asset-or-Nothing, One-Touch
                        </p>
                      </div>
                      <div className="bg-finance-steel/10 p-4 rounded-md">
                        <h4 className="text-finance-accent font-medium mb-2">Options à corridor</h4>
                        <p className="text-sm text-finance-lightgray">
                          Range Accrual, Corridor Options, Window Barrier Options
                        </p>
                      </div>
                      <div className="bg-finance-steel/10 p-4 rounded-md">
                        <h4 className="text-finance-accent font-medium mb-2">Autres structures</h4>
                        <p className="text-sm text-finance-lightgray">
                          Lookback, Asian, Basket Options, Rainbow Options
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mt-6 pt-6 border-t border-finance-steel/10">
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                      ...
                      <Link to="/courses/fundamentals/greeks" className="text-finance-accent hover:underline text-sm flex items-center">
...
export default ExoticOptionsCourse;
