...
const IntermediateWave = () => {
  const { t } = useTranslation();
  const navigate = useNavigate();
  
  const waveInfo = {
    id: 2,
    name: "Mode Survie: Intermédiaire",
    description: "Approfondissez vos connaissances avec des concepts plus avancés",
    challenges: 15,
    time: 20,
    topics: ["Arbres Binomiaux", "Options Américaines", "Stratégies de Couverture"]
  };
  ...
  const challenges = survivalChallengeTypes.intermediate;
            ...
            <div className="p-6">
              {!gameStarted && (
                <div className="text-center py-12">
                  ...
                  <h2 className="text-2xl font-bold mb-2">Prêt pour le niveau intermédiaire?</h2>
                  <p className="text-finance-lightgray mb-8 max-w-lg mx-auto">
                    Vous allez affronter {waveInfo.challenges} défis de niveau intermédiaire. 
...
export default IntermediateWave;
