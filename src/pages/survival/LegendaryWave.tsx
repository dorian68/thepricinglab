...
const LegendaryWave = () => {
  ...
  const waveInfo = {
    id: 6,
    name: "Mode Survie: Légendaire",
    description: "Le défi ultime pour les meilleurs experts en finance quantitative",
    challenges: 35,
    time: 40,
    topics: ["Taux Stochastiques", "Calibration de Marché", "XVA", "Modèles de Machine Learning"]
  };
  ...
  const challenges = survivalChallengeTypes.legendary;
            ...
            <div className="p-6">
              {!gameStarted && (
                <div className="text-center py-12">
                  ...
                  <h2 className="text-2xl font-bold mb-2">Prêt pour le niveau légendaire?</h2>
                  <p className="text-finance-lightgray mb-8 max-w-lg mx-auto">
                    Vous allez affronter {waveInfo.challenges} défis de niveau légendaire. 
