...
const MasterWave = () => {
  ...
  const waveInfo = {
    id: 5,
    name: "Mode Survie: Maître",
    description: "Affrontez les défis des produits structurés de haut niveau",
    challenges: 30,
    time: 35,
    topics: ["Produits Structurés", "Options Multi-Asset", "Structures Callable/Puttable"]
  };
  ...
  const challenges = survivalChallengeTypes.master;
            ...
            <div className="p-6">
              {!gameStarted && (
                <div className="text-center py-12">
                  ...
                  <h2 className="text-2xl font-bold mb-2">Prêt pour le niveau maître?</h2>
                  <p className="text-finance-lightgray mb-8 max-w-lg mx-auto">
                    Vous allez affronter {waveInfo.challenges} défis de niveau maître. 
