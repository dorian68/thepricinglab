...
const AdvancedWave = () => {
  ...
  const waveInfo = {
    id: 3,
    name: "Mode Survie: Avancé",
    description: "Mettez à l'épreuve votre expertise avec des concepts avancés",
    challenges: 20,
    time: 25,
    topics: ["Volatilité Stochastique", "Monte Carlo", "Options Exotiques Européennes"]
  };
  ...
  const challenges = survivalChallengeTypes.advanced;
            ...
            <div className="p-6">
              {!gameStarted && (
                <div className="text-center py-12">
                  ...
                  <h2 className="text-2xl font-bold mb-2">Prêt pour le niveau avancé?</h2>
                  <p className="text-finance-lightgray mb-8 max-w-lg mx-auto">
                    Vous allez affronter {waveInfo.challenges} défis de niveau avancé. 
