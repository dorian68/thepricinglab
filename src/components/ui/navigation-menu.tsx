...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-10 w-max items-center justify-center rounded-md bg-transparent px-4 py-2 text-sm font-medium transition-colors hover:bg-finance-steel/20 hover:text-finance-accent focus:bg-finance-steel/20 focus:text-finance-accent focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-finance-steel/30 data-[state=open]:bg-finance-steel/30"
)
